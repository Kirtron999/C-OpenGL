...
void subMenuShadeModelCheck(int choice) {
	switch (choice) {
	case 0:
		mode = GL_FLAT;
		break;
...
void MenuInit() {
	...
	int subMenuShadeModel = glutCreateMenu(subMenuShadeModelCheck);
	...
	glutSetMenu(subMenuShadeModel);
	glutAddMenuEntry("GL_FLAT", 0);
	...
	glutAddSubMenu("Shade Model", subMenuShadeModel);
