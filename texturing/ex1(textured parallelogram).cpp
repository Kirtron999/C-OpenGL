...
void ChangeSize(int w, int h)
{
	...
	// ѕредотвращает деление на нуль
	if (h == 0)
		h = 1;

	// ”станавливаем размеры пол€ просмотра равными размерам окна
	glViewport(0, 0, w, h);

	// ”станавливаем перспективную систему координат
	glMatrixMode(GL_PROJECTION);
	glLoadIdentity();

	// ”станавливает объем отсечени€ с помощью отсекающих 
	// плоскостей (лева€, права€, нижн€€, верхн€€, ближн€€, дальн€€) 
	...
	// ќбновл€етс€ стек матриц проекции модели
...
void SetupRC()
{
	...
	pBytes = (GLubyte *)gltLoadTGA("C:\\Users\\ ирилл\\Desktop\\tree.tga", &iWidth, &iHeight, &iComponents, &eFormat);
...
int main(int argc, char *argv[])
{
	...
	glutCreateWindow("Textured parallelepiped");
