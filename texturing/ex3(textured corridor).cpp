...
#define TEXTURE_LEAVES 4
#define TEXTURE_COUNT   5
GLuint  textures[TEXTURE_COUNT];
const char *szTextureFiles[TEXTURE_COUNT] = { "C:\\Users\\Кирилл\\Desktop\\tree.tga", "C:\\Users\\Кирилл\\Desktop\\2new.tga", "C:\\Users\\Кирилл\\Desktop\\brickwall.tga", "C:\\Users\\Кирилл\\Desktop\\rock.tga", "C:\\Users\\Кирилл\\Desktop\\leaves.tga" };
// Define targa header.
#pragma pack(1)
typedef struct
{
...
void RenderScene(void)
{
	...
	for (z = 60.0f; z >= 0.0f; z -= 10)
	{
		...
		glTexCoord2f(1.0f, 1.0f);
		glVertex3f(10.0f, 20.0f, z - 10.0f);

		glTexCoord2f(1.0f, 0.0f);
		glVertex3f(10.0f, 20.0f, z);
		...
		// Right Wall
		glBindTexture(GL_TEXTURE_2D, textures[TEXTURE_LEAVES]);
		glBegin(GL_QUADS);
		glTexCoord2f(0.0f, 1.0f);
		glVertex3f(10.0f, 20.0f, z);
