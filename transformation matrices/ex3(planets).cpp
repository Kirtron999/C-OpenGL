...
void RenderScene(void)
{
	...
	static float fSecSatelliteRot = 0.0f;
	...
	glPushMatrix(); //Сохраняем текущее положение
	...
	// поворот в системе координат земли
	// изображение второго спутника
	...
	glRotatef(fSecSatelliteRot, 1.0f, 0.0f, 0.0f);
	glTranslatef(0.0f, 30.0f, 0.0f);
	fSecSatelliteRot -= 10.0f;
	if (fSecSatelliteRot < 0.0f)
		fSecSatelliteRot = 360.0f;
