...
{
	GLfloat majorRadius = 0.20f;
	GLfloat minorRadius = 0.08f;
	GLint   numMajor = 40;
	GLint   numMinor = 20;
...
void RenderScene(void)
{
	...
	transformationMatrix[12] = -0.4f;
	transformationMatrix[13] = 0.4f;
	...
	//третий тор
	gltRotationMatrix(gltDegToRad(InvRot), 0.0f, 0.0f, 1.0f, transformationMatrix);
	transformationMatrix[12] = -0.4f;
	transformationMatrix[13] = -0.4f;
	transformationMatrix[14] = -2.5f;
	...
	//четвертый тор
	gltRotationMatrix(gltDegToRad(InvRot), 1.0f, 1.0f, 1.0f, transformationMatrix);
	transformationMatrix[12] = 0.4f;
	transformationMatrix[13] = -0.4f;
	transformationMatrix[14] = -2.5f;
	...
	glVertex3f(0, 400, -2.5);
	glVertex3f(0, -400, -2.5);

	//вертикальная линия
	glVertex3f(400, 0, -2.5);
	glVertex3f(-400, 0, -2.5);
	glEnd();
